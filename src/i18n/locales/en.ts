...
export const en: TranslationDict = {
  ...
  settingsUI: {
    ...
    deviceInvariantHelp: 'Helps compare different phones/microphones (linear effects). Limited help against aggressive noise suppression.',
    deviceInvariantMethod: 'Method',
    deviceInvariantMethodDct: 'DCT-Lifter Whitening',
    deviceInvariantMethodSmooth: 'Smooth Subtract',
    deviceInvariantStrength: 'Strength',
    deviceInvariantStrengthLow: 'Low',
    deviceInvariantStrengthMedium: 'Medium',
    deviceInvariantStrengthHigh: 'High',
    deviceInvariantZNorm: 'Z-Normalize',
    deviceInvariantZNormDesc: 'Normalize across frequency bins (remove mean loudness).',
    deviceInvariantZNormOn: 'Z-Normalize on',
    deviceInvariantZNormOff: 'Z-Normalize off',
    deviceInvariantABHint: 'For A/B test: record reference → export DB → import on another device → live test; then toggle mode and repeat.',
    deviceInvariantMismatchTitle: 'Feature mode mismatch',
    deviceInvariantMismatchDescription: 'Database uses {{dbMode}}. App is set to {{appMode}}.',
    deviceInvariantMismatchNotice: 'Database uses {{mode}}. You can apply these settings in Advanced audio settings.',
    deviceInvariantMismatchPrompt: 'Database uses {{dbMode}}. App is set to {{appMode}}. Apply database settings?',
    deviceInvariantApplyFromDb: 'Apply settings from database',
    deviceInvariantApplied: 'Settings applied from database.',
    deviceInvariantMixedModels: 'Reference models contain mixed feature modes. Please align or re-record.',
  ...
  diagnosisResults: {
    ...
    featureModeMixed: 'Mixed feature modes',
