...
export const fr: TranslationDict = {
  ...
  settingsUI: {
    ...
    deviceInvariantMixedModels: 'Les références utilisent des modes mixtes. Veuillez aligner ou réenregistrer.',
  ...
  diagnosisResults: {
    ...
    featureModeMixed: 'Modes de caractéristiques mixtes',
