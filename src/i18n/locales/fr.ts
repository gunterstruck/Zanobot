...
export const fr: TranslationDict = {
  ...
  machineSetup: {
    ...
    referenceDbUrl: 'Lien base de données',
    referenceDbUrlTitle: 'Base de données de référence (GitHub Pages)',
    referenceDbUrlRequired: 'Obligatoire',
    referenceDbUrlHintDetailed: 'Veuillez entrer le lien direct vers un fichier JSON situé dans le dépôt gunterstruck.github.io.',
    referenceDbUrlHint: 'Formats autorisés: https://gunterstruck.github.io/<chemin>/<fichier>.json ou https://raw.githubusercontent.com/gunterstruck/gunterstruck.github.io/main/<chemin>/<fichier>.json — Les autres sources (Google Drive, etc.) ne sont pas supportées.',
    location: 'Emplacement',
    locationPlaceholder: 'ex: Bâtiment 3, Ligne 2',
    notes: 'Notes',
    notesPlaceholder: 'Notes supplémentaires pour les techniciens',
    urlEmpty: 'Veuillez entrer un lien vers la base de données.',
    urlInvalid: 'Le lien ne semble pas être une URL valide.',
    urlNotHttps: 'Le lien doit commencer par https://.',
    urlNotJson: 'Le lien doit pointer vers un fichier .json.',
    urlInvalidSource: 'Seuls les liens vers gunterstruck.github.io sont autorisés. Les autres sources ne sont pas supportées.',
    googleDriveNotDirect: 'Google Drive n\'est pas supporté. Veuillez utiliser gunterstruck.github.io.',
    downloadingReference: 'Chargement des données de référence...',
    statusDownloading: 'Téléchargement des données...',
    statusParsing: 'Traitement des données...',
    statusValidating: 'Validation du format...',
    statusSaving: 'Enregistrement local...',
    statusComplete: 'Terminé!',
    errorMachineNotFound: 'Machine non configurée. Veuillez contacter le technicien.',
    errorDownloadFailed: 'Échec du téléchargement. Vérifiez votre connexion.',
    errorInvalidFormat: 'Les données de référence ont un format invalide.',
    referenceLoaded: 'Données de référence chargées!',
    nfcMachineLink: 'Lien machine pour NFC',
    exportDbTitle: 'Exporter la base de données',
    exportDbDescription: 'Exportez la base de données avec tous les modèles pour télécharger sur gunterstruck.github.io.',
    exportDbButton: 'Exporter la base',
    exportDbHint: 'Le fichier JSON exporté peut être téléchargé dans le dépôt gunterstruck.github.io.',
  },
