...
export const es: TranslationDict = {
  ...
  settingsUI: {
    ...
    recordingDuration: 'Duración de grabación', seconds: 'segundos',
    frequencyAxis: 'Eje de frecuencia', frequencyLogDesc: 'Logarítmico (más detalle en rango 20-500 Hz)',
    amplitudeAxis: 'Eje Y / Amplitud', amplitudeLogDesc: 'Logarítmico (dB) – enfatiza señales débiles',
  ...
  themes: {
    neonTitle: 'Neon Industrial', neonDesc: 'Estilo cyberpunk con neón cyan y naranja. Perfecto para entornos oscuros.',
    daylightTitle: 'Daylight', daylightDesc: 'Modo brillante de alto contraste. Óptimo para sol y exteriores.',
    brandTitle: 'Zanobo', brandDesc: 'Diseño Zanobo original. Equilibrado y profesional.',
  },
  level2Default: {
