...
export const zh: TranslationDict = {
  ...
  machineSetup: {
    title: '机器设置',
    referenceDbUrl: '参考数据库链接',
    referenceDbUrlTitle: '参考数据库（GitHub Pages）',
    referenceDbUrlRequired: '必填',
    referenceDbUrlHintDetailed: '请输入位于 gunterstruck.github.io 仓库中的 JSON 文件的直接链接。',
    referenceDbUrlHint: '允许的格式：https://gunterstruck.github.io/<路径>/<文件>.json 或 https://raw.githubusercontent.com/gunterstruck/gunterstruck.github.io/main/<路径>/<文件>.json — 不支持其他来源（如 Google Drive）。',
    location: '位置',
    locationPlaceholder: '例如：3号厂房，2号生产线',
    notes: '备注',
    notesPlaceholder: '技术人员的附加说明',
    urlEmpty: '请输入参考数据库链接。',
    urlInvalid: '该链接似乎不是有效的URL。',
    urlNotHttps: '链接必须以 https:// 开头。',
    urlNotJson: '链接必须指向 .json 文件。',
    urlInvalidSource: '只允许链接到 gunterstruck.github.io。不支持其他来源。',
    googleDriveNotDirect: '不支持 Google Drive。请使用 gunterstruck.github.io。',
    downloadingReference: '正在加载参考数据...',
    statusDownloading: '正在下载数据...',
    statusParsing: '正在处理数据...',
    statusValidating: '正在验证格式...',
    statusSaving: '正在本地保存...',
    statusComplete: '完成！',
    errorMachineNotFound: '机器未配置。请联系技术人员。',
    errorDownloadFailed: '下载失败。请检查您的网络连接。',
    errorInvalidFormat: '参考数据格式无效。',
    referenceLoaded: '参考数据加载成功！',
    nfcMachineLink: '机器的NFC链接',
    exportDbTitle: '导出数据库',
    exportDbDescription: '导出包含所有模型的数据库，以便上传到 gunterstruck.github.io。',
    exportDbButton: '导出数据库',
    exportDbHint: '导出的JSON文件可以上传到 gunterstruck.github.io 仓库。',
  },
