...
export const de: TranslationDict = {
  ...
  settingsUI: {
    ...
    deviceInvariantMixedModels: 'Referenzen enthalten gemischte Feature-Modi. Bitte vereinheitlichen oder neu aufnehmen.',
  ...
  diagnosisResults: {
    ...
    featureModeMixed: 'Gemischte Feature-Modi',
