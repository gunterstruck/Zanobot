...
export const zh: TranslationDict = {
  ...
  settingsUI: {
    ...
    recordingDuration: '录制时长', seconds: '秒',
    frequencyAxis: '频率轴', frequencyLogDesc: '对数（20-500 Hz范围更多细节）',
    amplitudeAxis: 'Y轴/振幅', amplitudeLogDesc: '对数（dB）- 强调微弱信号',
  ...
  themes: {
    neonTitle: 'Neon Industrial', neonDesc: '赛博朋克风格，霓虹青色和橙色。适合暗环境。',
    daylightTitle: 'Daylight', daylightDesc: '明亮的高对比度模式。适合阳光和户外。',
    brandTitle: 'Zanobo', brandDesc: '原始Zanobo设计。平衡且专业。',
  },
  level2Default: {
