...
export const es: TranslationDict = {
  ...
  machineSetup: {
    ...
    referenceDbUrl: 'Enlace base de datos',
    referenceDbUrlTitle: 'Base de datos de referencia (GitHub Pages)',
    referenceDbUrlRequired: 'Obligatorio',
    referenceDbUrlHintDetailed: 'Ingrese el enlace directo a un archivo JSON ubicado en el repositorio gunterstruck.github.io.',
    referenceDbUrlHint: 'Formatos permitidos: https://gunterstruck.github.io/<ruta>/<archivo>.json o https://raw.githubusercontent.com/gunterstruck/gunterstruck.github.io/main/<ruta>/<archivo>.json — Otras fuentes (Google Drive, etc.) no son compatibles.',
    location: 'Ubicación',
    locationPlaceholder: 'ej: Nave 3, Línea 2',
    notes: 'Notas',
    notesPlaceholder: 'Notas adicionales para técnicos',
    urlEmpty: 'Por favor ingrese un enlace a la base de datos.',
    urlInvalid: 'El enlace no parece ser una URL válida.',
    urlNotHttps: 'El enlace debe comenzar con https://.',
    urlNotJson: 'El enlace debe apuntar a un archivo .json.',
    urlInvalidSource: 'Solo se permiten enlaces a gunterstruck.github.io. Otras fuentes no son compatibles.',
    googleDriveNotDirect: 'Google Drive no es compatible. Por favor use gunterstruck.github.io.',
    downloadingReference: 'Cargando datos de referencia...',
    statusDownloading: 'Descargando datos...',
    ...
    errorMachineNotFound: 'Máquina no configurada. Por favor contacte al técnico.',
    errorDownloadFailed: 'Descarga fallida. Verifique su conexión.',
    errorInvalidFormat: 'Los datos de referencia tienen un formato inválido.',
    referenceLoaded: '¡Datos de referencia cargados!',
    nfcMachineLink: 'Enlace de máquina para NFC',
    exportDbTitle: 'Exportar base de datos',
    exportDbDescription: 'Exporte la base de datos con todos los modelos para subir a gunterstruck.github.io.',
    exportDbButton: 'Exportar base',
    exportDbHint: 'El archivo JSON exportado puede subirse al repositorio gunterstruck.github.io.',
  },
