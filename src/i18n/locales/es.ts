...
export const es: TranslationDict = {
  ...
  modals: {
    ...
    nfcDiagnosisPrompt: 'Máquina detectada. ¿Iniciar el diagnóstico ahora?',
  },
  ...
  settingsUI: {
    ...
    deviceInvariantMixedModels: 'Los modelos de referencia tienen modos mezclados. Alinee o vuelva a grabar.',
  ...
  diagnosisResults: {
    ...
    featureModeMixed: 'Modos de características mezclados',
